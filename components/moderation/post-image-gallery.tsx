        ...
        <div className="flex gap-2 overflow-x-auto pb-1">
          {images.map((image, imageIndex) => (
            <button
              ...
              className="size-16 shrink-0 cursor-pointer overflow-hidden rounded-md border-2 border-transparent bg-muted transition-colors aria-current:border-primary"
            >
              {/* eslint-disable-next-line @next/next/no-img-element -- backend image hosts are dynamic */}
